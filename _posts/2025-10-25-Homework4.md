...
<body>
        ...
        <div class = "panel">
            <div class="controls">
                <div class="single-control">
                    ...
                    <div class="row">
                      <input id="p" type="range" min="0" max="1" step="0.01" value="0.5" style="accent-color:#219827;">
                    </div>
                    <div class="row">
                      <input id="pText" type="number" min="0" max="1" step="0.01" value="0.5">
                    </div>
                </div>
                <div class="single-control">
            ...
            <div class="board">
                ...
                <div class="canvas-wrap"><canvas id="freq" width="900" height="360" style="width:100%; height:360px; display:block;"></canvas></div>
                <div class="legend">
  ...
  //--- canvas ----
   ...
   <script defer src="{{ '/assets/js/hw4.js' | relative_url }}"></script>
  </body>
</html>
